...
print_header() {
    echo -e "${PURPLE}═══════════════════════════════════════${NC}"
    echo -e "${PURPLE}  🤖 AETHERIS Trading Bot - PM2 Manager${NC}"
    echo -e "${PURPLE}═══════════════════════════════════════${NC}"
    echo ""
}
...
start_services() {
    ...
    echo ""
    echo -e "${CYAN}📊 访问地址:${NC}"
    echo -e "  ${GREEN}前端:${NC} http://localhost:3434"
    echo -e "  ${GREEN}后端 API:${NC} http://localhost:3636"
    echo ""
    echo -e "${CYAN}📝 查看日志:${NC}"
...
show_status() {
    ...
    echo ""
    print_info "详细信息:"
    pm2 info aetheris-backend
    echo ""
    pm2 info aetheris-frontend
}
