...
echo ""
echo "╔═══════════════════════════════════════════╗"
echo "║  AETHERIS PR Migration Tool                   ║"
...
if ! git rev-parse --is-inside-work-tree > /dev/null 2>&1; then
    log_error "Not a git repository. Please run this from your AETHERIS fork."
    exit 1
fi
...
log_info "Telegram: https://t.me/aetheris_dev_community"

echo ""
log_success "Thank you for contributing to AETHERIS! 🚀"
echo ""
