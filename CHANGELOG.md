...
All notable changes to the AETHERIS project will be documented in this file.
...
This is a **major breaking update** that completely transforms AETHERIS from a static config-based system to a modern web-based trading platform.
...
- [GitHub Repository](https://github.com/tinkle-community/aetheris)
